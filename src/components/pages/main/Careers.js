...
const Careers = () => {
  ...
  const filteredJobs = jobs.filter((job) => {
    const matchesSearch = job.title.toLowerCase().includes(searchTerm.trim().toLowerCase());
    ...
    <div className="w-full">
      ...
      <section className="relative bg-gradient-to-r from-blue-900 to-indigo-900 py-32">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
            Build the future of software with us. We're looking for talented individuals who are passionate about innovation.
          </p>
          ...
          <div className="max-w-2xl mx-auto relative">
            <div className="flex items-center bg-white rounded-lg shadow-lg">
              <input
                ...
                className="flex-1 px-4 py-2 text-gray-900 text-lg focus:outline-none"
                value={searchTerm}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-900">Why Join Aslan AI?</h2>
          <p className="text-gray-600 mt-4">Discover the benefits of working with us</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
            {[
              {
                icon: <FaBuilding className="text-3xl text-blue-600" />,
                title: "Modern Workplace",
                description: "Work in a state-of-the-art office or remotely with the latest tools and technologies.",
              },
              {
                icon: <FaUsers className="text-3xl text-green-600" />,
                title: "Great Team Culture",
                description: "Join a diverse and inclusive team that values collaboration and innovation.",
              },
              {
              ...
              },
              {
                ...
                description: "Access to learning resources, workshops, and conferences.",
              },
            ].map((benefit, idx) => (
              <div key={idx} className="bg-white p-8 rounded-lg shadow-lg text-center">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4">Find your next career opportunity</p>
          </div>
